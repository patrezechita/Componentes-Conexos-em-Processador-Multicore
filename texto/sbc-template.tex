...
\begin{figure}[h!]
	\begin{minipage}[b]{0.5\textwidth}
		...
		{
		\begin{tabular}{ll}
		\includegraphics[width=1\textwidth]{grafo.pdf} & \begin{tabular}{ll}
\multicolumn{2}{l}{lista de adjacência}  \\ \cline{1-1}
\multicolumn{1}{|l|}{0} & $\to2\to3$     \\ \cline{1-1}
\multicolumn{1}{|l|}{1} & $\to4$         \\ \cline{1-1}
\multicolumn{1}{|l|}{2} & $\to0\to3$     \\ \cline{1-1}
\multicolumn{1}{|l|}{3} & $\to6\to2\to0$ \\ \cline{1-1}
\multicolumn{1}{|l|}{4} & $\to7\to1\to5$ \\ \cline{1-1}
\multicolumn{1}{|l|}{5} & $\to4$         \\ \cline{1-1}
\multicolumn{1}{|l|}{6} & $\to3$         \\ \cline{1-1}
\multicolumn{1}{|l|}{7} & $\to4$         \\ \cline{1-1}
\multicolumn{1}{|l|}{8} & $\to9$         \\ \cline{1-1}
\multicolumn{1}{|l|}{9} & $\to8$         \\ \cline{1-1}
\end{tabular}
		\end{tabular}
		}
	    \caption{entrada}
	...
	\begin{minipage}[b]{0.5\textwidth}
		\resizebox{\textwidth}{!}
		{
			\begin{tabular}{ccll}
\begin{tabular}{ll}
\multicolumn{2}{l}{vInicial}                  \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{0} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_1$} & \multicolumn{1}{l|}{3} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_2$} & \multicolumn{1}{l|}{6} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_3$} & \multicolumn{1}{l|}{8} \\ \cline{2-2} 
\end{tabular} & \begin{tabular}{ll}
\multicolumn{2}{l}{vFinal}                  \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{2} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_1$} & \multicolumn{1}{l|}{5} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_2$} & \multicolumn{1}{l|}{7} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_3$} & \multicolumn{1}{l|}{9} \\ \cline{2-2} 
\end{tabular} & \begin{tabular}{ll}
\multicolumn{2}{l}{floresta}                                  \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{\{$\emptyset$\}} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_1$} & \multicolumn{1}{l|}{\{$\emptyset$\}} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_2$} & \multicolumn{1}{l|}{\{$\emptyset$\}} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_3$} & \multicolumn{1}{l|}{\{$\emptyset$\}} \\ \cline{2-2} 
\end{tabular} & \begin{tabular}{lllllllllll}
...
\begin{figure}[h!]
	\begin{minipage}[b]{0.5\textwidth}
		\resizebox{\textwidth}{!}
		{
			...
			\begin{tabular}{ll}
\multicolumn{2}{l}{floresta}                                                                                                    \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{\{(0,2),(0,3),(1,4)\}}                                                             \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_1$} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}\{(0,3),(3,2),(6,3),\\ (1,4),(4,5),(7,4)\}\end{tabular}} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_2$} & \multicolumn{1}{l|}{\{(3,6),(4,7)\}}                                                                   \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_3$} & \multicolumn{1}{l|}{\{(8,9)\}}                                                                         \\ \cline{2-2} 
\end{tabular}
&
...
\end{tabular}
	...
	\begin{minipage}[b]{0.5\textwidth}
		...
		\begin{tabular}{ll}
\multicolumn{2}{l}{floresta}                                                                                                    \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}\{(0,2),(0,3),(1,4),\\ (6,3),(4,5),(1,4)\}\end{tabular}} \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_2$} & \multicolumn{1}{l|}{\{(3,6),(4,7),(8,9)\}}                                                             \\ \cline{2-2} 
\end{tabular} &
		\begin{tabular}{lllllllllll}
\multicolumn{11}{l}{componente}                                                                                                                                                                                                                                                     \\
                           & $ _0$                  & $ _1$                  & $ _2$                  & $ _3$                  & $ _4$                  & $ _5$                  & $ _6$                  & $ _7$                  & $ _8$                  & $ _9$                  \\ \cline{2-11} 
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.5\textwidth}
		\resizebox{\textwidth}{!}
		{
			...
			\begin{tabular}{ll}
\multicolumn{2}{l}{floresta}                                                                                                                \\ \cline{2-2} 
\multicolumn{1}{l|}{$t_0$} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}\{(0,2),(0,3),(1,4),\\ (6,3),(4,5),(1,4),\\ (8,9)\}\end{tabular}} \\ \cline{2-2} 
\end{tabular} &
\begin{tabular}{lllllllllll}
\multicolumn{11}{l}{componente}                                                                                                                                                                                                                                                     \\
                           & $ _0$                  & $ _1$                  & $ _2$                  & $ _3$                  & $ _4$                  & $ _5$                  & $ _6$                  & $ _7$                  & $ _8$                  & $ _9$                  \\ \cline{2-11} 
...
\begin{figure}
 ...
 &  &  &  & \multicolumn{1}{c|}{$t_1$} & \multicolumn{6}{l|}{\begin{tabular}[c]{@{}l@{}}\{(3,6),(3,2),(3,0),\\ (4,7),(4,1),(4,5)\}\end{tabular}} \\ \cline{6-11} 
...
\multicolumn{1}{c|}{$t_3$} & \multicolumn{1}{c|}{0} & \multicolumn{1}{c|}{1} & \multicolumn{1}{c|}{2} & \multicolumn{1}{c|}{3} & \multicolumn{1}{c|}{4} & \multicolumn{1}{c|}{5} & \multicolumn{1}{c|}{6} & \multicolumn{1}{c|}{7} & \multicolumn{1}{c|}{8} & \multicolumn{1}{c|}{8} \\ \cline{2-11} 
\end{tabular}
		  }
		  \caption{}
	\end{subfigure}
		\begin{subfigure}{.33\textwidth}
		  ...
		  \resizebox{0.9\textwidth}{!}
		  {
		  	\includegraphics[width=0.95\linewidth]{figD.pdf}
		  }
		  \caption{}
	\end{subfigure}%
	\begin{subfigure}{.33\textwidth}
...
\subcaptionbox{}[.32\textwidth]
  {\resizebox{0.3\textwidth}{!}
		  {\includegraphics[width=1\linewidth]{dog.jpg}}}
\subcaptionbox{}[.32\textwidth]
...
\end{tabular}
  ...
  \caption{demorei um tempão nisso}
\end{figure}
k
\lipsum[1]
